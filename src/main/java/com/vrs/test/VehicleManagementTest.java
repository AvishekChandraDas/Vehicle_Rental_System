...
public class VehicleManagementTest {
    ...
    private static void testAddVehicles(VehicleController controller) {
        ...
        String[][] testVehicles = {
            {"Toyota", "Camry", "Car", "ABC-123", "45.00", "Silver", "2022", "5", "Comfortable sedan for family trips"},
            {"Honda", "Civic", "Car", "DEF-456", "40.00", "Blue", "2021", "5", "Reliable and fuel-efficient car"},
            {"Ford", "Transit", "Van", "GHI-789", "65.00", "White", "2020", "12", "Spacious van for group travel"},
